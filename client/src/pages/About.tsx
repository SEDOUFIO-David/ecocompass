 ...
 */
import { ArrowRight, BookOpenCheck, CheckCircle2, Compass, Database, ExternalLink, ShieldCheck } from "lucide-react";
...
export default function About() {
  return <SiteShell>
    ...
    <section className="about-creator"><div className="container about-creator-inner"><div><p className="eyebrow">Créateur du projet</p><h2>SEDOUFIO Kossi David</h2><p><em>Économiste du développement — Créateur d'EcoCompass</em></p></div></div></section>
