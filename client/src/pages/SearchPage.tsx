...
export default function SearchPage() {
  ...
  return <SiteShell>
    <section className="search-hero"><div className="container"><p className="eyebrow">Recherche globale V4</p><h1>Trouvez une notion,<br />un cours, une pratique ou une piste.</h1><div className="search-box"><SearchIcon size={22} /><label className="sr-only" htmlFor="global-search">Rechercher dans EcoCompass</label><input id="global-search" autoFocus value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Ex. inflation, data analyst, formation, opportunité…" /><kbd>⌘ K</kbd></div><p className="mt-4 text-sm text-[#B9D1C5]">La recherche relie maintenant cours, métiers, formations, établissements, opportunités, compétences, projets, données et ressources.</p></div></section>
